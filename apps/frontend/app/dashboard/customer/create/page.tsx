      ...
      >
        ...
        >
          <Row gutter={16}>
            ...
            <Col span={24} md={12}>
              <Form.Item
                ...
                rules={[
                  {
                    pattern: /^\d+$/,
                    message: "Hanya masukkan karakter angka",
                  },
                ]}
              >
            ...
            <Col span={24}>
              <Form.Item name="address" label="Alamat (Optional)">
                <Input.TextArea
                  rows={2}
                    ...
                    <Row gutter={16}>
                      <Col span={24} md={8}>
                        <Form.Item
                          ...
                          label="Nama Pet"
                          rules={[
                            { required: true, message: "Nama pet wajib diisi" },
                          ]}
                        >
                      ...
                      <Col span={24} md={8}>
                        <Form.Item
                          ...
                          rules={[
                            {
                              required: true,
                              message: "Jenis hewan wajib diisi",
                            },
                          ]}
                        >
